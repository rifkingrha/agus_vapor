                ...
                <div class="col-12">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-header">
                            <h3 class="card-title">Pesanan Selesai <?= $this->session->userdata('username') ?></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="tabel_pesanan_selesai" class="table table-bordered table-hover text-center">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>No Transaksi</th>
...
<script>
    $(document).ready(function() {
        $('#tabel_pesanan_selesai').DataTable({
            "responsive": true,
            'processing': true,
            'ajax': {
                'url': "<?php echo base_url('Kelola_pesanan/getPesananSelesai'); ?>",
        ...
        $(".form-input").on("submit", function(event) {
            ...
            $.ajax({
                ...
                $("#tabel_pesanan_selesai").DataTable().ajax.reload(function() {
        ...
        $('#tabel_pesanan_selesai').on('click', '.btn-edit', function() {
